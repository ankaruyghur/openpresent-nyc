...
export const Card = ({
  ...
  return (
    <>
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-[100] h-screen overflow-auto mx-2">
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="fixed inset-0 h-full w-full bg-black/80 backdrop-blur-lg rounded-lg"
            />
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              className="relative z-[110] mx-auto my-2 md:my-10 h-fit max-w-5xl rounded-lg bg-neutral-900 p-4 font-sans md:p-10"
            >
              <button
              ...
              <motion.p
                ...
                className="mt-2 md:mt-4 text-2xl font-semibold text-white md:text-5xl"
              >
                {card.title}
              </motion.p>
              <div className="py-2 md:py-4">{card.content}</div>
            </motion.div>
          </div>
        )}
      </AnimatePresence>
